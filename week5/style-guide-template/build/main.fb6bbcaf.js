...
var rbgToHex = function rbgToHex(elem) {
  if (elem.currentStyle) var bg = elem.currentStyle['background-color'] elif (window.getComputedStyle) var bg = document.defaultView.getComputedStyle(elem, null).getPropertyValue('background-color') 
